        ...
        <div className='top flex justify-between mb-4'>
            <div className='left s flex items-center gap-4'>
              ...
              <img src={Icons} className='' alt='' />
                ...
                <div className=''>
                    <h6 className='font-normal font-rubik text-[#000000] text-xl leading-9'>Number of Orders</h6>
                    <h6 className='font-bold font-rubik text-[#2591fa] text-xl leading-9'>1,200</h6>
