...
const Totalrevenuecard = () => {
  return (
    ...
    <div className='top flex justify-between mb-4'>
        <div className='left flex  items-center gap-4'>
          ...
          <img src={Icons} className='' alt='' />
            ...
            <div className=''>
                <h6 className='font-normal font-rubik text-[#000000] text-xl leading-9'>Total Revenue</h6>
                <h6 className='font-bold font-rubik text-[#04b076] text-xl leading-9'>13,200</h6>
    ...
    <div className='down flex items-center mt-6 gap-2' >
      ...
      <p className='font-medium font-rubik text-[#04B076] text-xl leading-7'>+55.45%</p>
