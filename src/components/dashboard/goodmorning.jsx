    ...
    <div  className='flex flex-wrap  justify-between font-inter border border-[#ebebeb] bg-white  rounded py-6 px-8 items-center'>
      <div className='left flex flex-col gap-2 relative'>
        ...
        <div className='flex gap-2'>
          <h4 className='font-lexend font-bold  text-3xl leading-9 text-[#404040] '>
            John Deo
          </h4>
      ...
      <div className='right mt-4 md:mt-0'>
        <a href='/productform'>
          <button className='font-lexend flex py-[10px] px-[16px] bg-[#634af9] text-[14px] font-semibold leading-7 text-white rounded items-center  gap-2'>
