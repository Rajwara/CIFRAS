...
const Reportgallery = () => {
    ...
    return (
      <div className="flex flex-col px-6 py-10 border border-[#ebebeb] rounded">
        <ul className="flex flex-row justify-between text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0">
          <div className="flex">
          ...
          <div className="flex">
            <div className="w-full mr-10">
              <label
                ...
                className="leading-4 text-base font-medium text-gray-900 sr-only dark:text-white font-rubik"
              >
                Search
              </label>
              <div className="relative">
                ...
                <input
                  type="search"
                  id="default-search"
                  className="font-rubik font-normal block w-full p-3 ps-10 text-base text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <div className="flex flex-col mt-6">
          <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Administrative Reports</h3>
          <div className="card grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="flex flex-col mt-6">
          <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Accounting Reports</h3>
          <div className="card grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
