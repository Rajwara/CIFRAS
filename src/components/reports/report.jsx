...
const Report = () => {
  return (
    ...
    <div className='left flex flex-col gap-2 relative'>
        <h2 className='font-lexend font-bold text-[#404040] text-4xl leading-9'>Reports</h2>
        <p className='font-inter font-normal text-[#404040] text-lg leading-7'>Get a complete view of your company's accounting, administrative and tax information.</p>
    </div>
    <div className='right'>
      <a href='/clientform'>
