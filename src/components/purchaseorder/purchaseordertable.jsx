...
const Purchaseordertable = () => {
  ...
  // Define a separate ProgressBar component
  ...
  const allData = [
    {
      ...
      vendor: "undefined",
      unitprice: "$0.00",
      stock: <ProgressBar percentage={45} />,
      status: "undefined",
    },
    {
      id: 2,
  ...
  //     if (typeof stockData === 'string' && stockData.includes('bg-blue-600')) {
  //       return <div dangerouslySetInnerHTML={{ __html: stockData }} />;
  //     } else {
  //       return <span>{stockData}</span>;
  //     }
  //   };
    ...
    <div className='border border-[#ebebeb] rounded '>
      <div className='flex items-center justify-between rounded flex-column p-8 flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-white '>
        ...
        <div className='flex flex-col md:flex-row gap-6'>
          ...
          >
            <ul
              className='py-1 text-sm font-inter text-[#404040] '
