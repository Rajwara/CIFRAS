...
const Purchaseorderform = () => {
  ...
  const productformSchema = Yup.object().shape({
    purchaseorderId: Yup.string().min(1, "It's too short").max(20, "It's too long").required('Please Enter Item Number'),
    description: Yup.string().min(10, 'It\'s too short').required('Description is Required'),
    unitprice: Yup.string().min(1, 'Unit Price is too short').required('Unit Price is Required'),
    unitofmeasure: Yup.string().min(1, 'Unit of Measure is too short').required('Unit of Measure is Required'),
    availablestock: Yup.string().min(1, 'Available Stock is too short').required('Available Stock is Required'),
    dateofpurchasing: Yup.string().min(1, 'Date of Purchasing is too short').required('Date of Purchasing is Required'),
    vendor: Yup.string().min(1, "It's too short").max(200, "It's too long").required('Please Enter Your Vendor'),
            ...
            {(props) => (
              <Form className='flex flex-col items-center justify-center'>
                <div className='w-full mb-4'>
                   <label htmlFor="purchaseorderId"  className="block mb-2 text-base font-normal text-[#404040] font-inter leading-7">Purchase Order ID</label>
                   <Field type="number" name="purchaseorderId" id="small-input" placeholder='Item Number' className="border border-[#ebebeb] text-[#c0c0c0] sm:text-sm  rounded-md leading-5 font-normal font-inter  block w-full p-2.5" />
                   <ErrorMessage name="purchaseorderId" component="div" className="text-red-500 text-sm mt-1" />
              </div>
              <div className="w-full mb-4">
                  ...
                  <Field as="textarea" id="description" name="description" rows="8" placeholder="Description" class=" block w-full px-0 text-sm text-gray-800 bg-white border-0  focus:ring-0  font-inter" /> 
                    </div>
                </div>
                  ...
                  <div className='flex flex-row gap-4 w-full mb-4'>
                      <div className='w-full'>
                          <label htmlFor="availablestock"  className="block mb-2 text-base font-normal text-[#404040] font-inter leading-7">Available Stock</label>
                          <Field type="number" name="availablestock" id="small-input" placeholder='items left' className="border border-[#ebebeb] text-[#c0c0c0] sm:text-sm  rounded-md leading-5 font-normal font-inter  block w-full p-2.5" />
                          <ErrorMessage name="availablestock" component="div" className="text-red-500 text-sm mt-1" />
                      </div>
                      <div className='w-full'>
                          <label htmlFor="dateofpurchasing"  className="block mb-2 text-base font-normal text-[#404040] font-inter leading-7" >Date of Purchasing</label>
                          <Field type="number" name="dateofpurchasing" id="small-input" placeholder='1 Jan, 2014' className="border border-[#C0C0C0] text-[#c0c0c0] sm:text-sm  rounded-md leading-5 font-normal font-inter  block w-full p-2.5" />
                          <ErrorMessage name="dateofpurchasing" component="div" className="text-red-500 text-sm mt-1" />
                      </div>
                  </div>
                  <div className='w-full mb-4'>
