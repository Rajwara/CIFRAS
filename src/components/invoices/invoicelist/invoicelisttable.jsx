...
const Invoicelisttable = () => {
  ...
  return (
    <div className=' relative overflow-x-auto shadow-md border border-[#ebebeb] rounded bg-white pb-4'>
      <div class='flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-white dark:bg-gray-900  p-5'>
        ...
        <div class='relative'>
          ...
          <input
            ...
            class='font-inter block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg md:w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'
        ...
        <div className='flex flex-col md:flex-row gap-6'>
          ...
          <button
            ...
            className='inline-flex border border-[#ebebeb] rounded-md px-4 py-2 gap-2 items-center text-[#404040] font-normal font-inter text-base bg-white  focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200  '
            type='button'
          >
      ...
      <table
        ref={tableRef}
        className='w-full text-sm text-left rtl:text-right text-[#404040] '
      >
        ...
        <tbody className='text-[#404040]'>
          {currentData.map((item) => (
            <tr key={item.id} className='bg-white border-b  hover:bg-gray-50'>
              ...
              <td>
                <div className='ps-3'>
                  <div className='text-base font-medium font-inter'>
                    {item.created}
                  </div>
