  ...
  return (
    <div className='  bg-white items-center'>
      ...
      <div className='grid grid-cols-2  px-8 bg-white items-center  '>
        <div className='flex gap-10  '>
          <div className='-mt-[20px] md:mt-[-60px]'>
            <div class='relative w-64 '>
              <img
                class='md:w-64 h-20  md:h-64 rounded-full absolute'
                src={MainProfileImg}
                alt=''
              />
              ...
              <label
                for='dropzone-file'
                class='flex flex-col items-center justify-center w-20 md:w-full h-20 md:h-64 border-2 border-gray-300  rounded-full cursor-pointer bg-gray-50  hover:bg-gray-100 '
              >
                <div class='z-10 h-2'>
          ...
          <div className='my-20 -ml-[200px] md:-ml-0 '>
            ...
            <div className=' flex flex-row gap-4 md:gap-6 mt-40 md:mt-16 -ml-[120px]'>
              <div className='gap-2 md:gap-6 flex '>
        ...
        <div className='items-center justify-end flex flex-col md:flex-row gap-5 mt-8 -ml-[50px] md:-ml-0'>
          <a href='/' className=''>
      ...
      <div className='px-8 font-inter md:ml-6'>
          ...
          <Tabs.Item active title='Posts' icon={HiUserCircle}>
            <div class='grid grid-cols-2 md:grid-cols-4 gap-4 mt-20 pt-5'>
              <div class='grid gap-4'>
                <div>
                  <img
                    class='h-auto max-w-full rounded-lg mb-5'
                ...
                <div>
                  <img
                    class='h-auto max-w-full rounded-lg my-5'
