  ...
  return (
    <div className='px-8'>
      <div>
        ...
        {/* name form  */}
        <div className='flex flex-col md:flex-row mt-10   justify-between mb-4 md:mb-10'>
          <div className='md:w-[30%]'>
        ...
        <div className='flex flex-col md:flex-row  justify-between my-2 md:my-20'>
          <div className='md:w-[30%]'>
            <h4 className='font-lexend font-bold text-[#404040] text-xl leading-9'>
              Email Address
            </h4>
        ...
        <div className='flex flex-col md:flex-row  justify-between md:my-20'>
          <div className='md:w-[30%]'>
            <h4 className='font-lexend font-bold text-[#404040] text-xl leading-9'>
              Role
            </h4>
                  ...
                  <div className='mb-5 '>
                    ...
                    >
                      <ul
                        ...
                        aria-labelledby='dropdownDelayButt'
                      >
                        <li>
                          <a
                            href='#'
                ...
                <div className='w-full'>
                  <div className='mb-5 '>
                    ...
                    >
                      <ul
                        class='py-2 text-sm text-gray-700 '
                        aria-labelledby='dropdownDelayButto'
                      >
                        <li>
                          <a
                            href='#'
