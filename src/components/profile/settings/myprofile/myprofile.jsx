    ...
    <div>
      <div>
          ...
          <div className='grid grid-cols-2 px-8 bg-white items-center -mt-[30px]  md:mt-[-80px]'>
            <div className='flex  gap-10  '>
              <div class='relative w-64 '>
                <img
                  class='w-64  lg:h-0 xl:h-64 rounded-full absolute'
                  src={MainProfileImg}
                  alt=''
                />
        ...
        <div className='px-8 mt-8 md:mt-0'>
                ...
                <div>
                  <div class='flex'>
                    ...
                    <input
                      type='text'
                      id='website-admin'
                      class='rounded-none rounded-e-lg bg-gray-50 border border-gray-300 font-normal font-inter text-[#404040]  focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-base p-2.5  '
                      placeholder='Giselle'
                    />
                  </div>
                </div>
          ...
          <div className='flex flex-col md:flex-row  justify-between my-4 md:my-20'>
            <div className='md:w-[30%]'>
              <h4 className='font-lexend font-bold text-[#404040] text-xl leading-9'>
                Bio
              </h4>
                ...
                <div>
                  <div className='w-full'>
                    ...
                    <div class='flex items-center'>
                      ...
                      <label
                        for='link-checkbox'
                        class='ms-2 text-sm font-inter font-normal text-gray-900 '
                      >
