              ...
              <Form className='flex flex-col items-center justify-center'>
                <div className='flex flex-row gap-4 mb-4 w-full'>
                  <div className='w-full'>
                    ...
                    <Field type="text" id="name" name="name" placeholder='Item Number' value={clientName} onChange={(e)=>{setClientName(e.target.value);}} className="border border-[#C0C0C0] text-[#c0c0c0] sm:text-sm  rounded-md leading-5 font-normal font-rubik  block w-full p-2.5" />
                  ...
                  <div className='w-full'>
                    ...
                    <Field type="number" id="phonenumber" name="phonenumber" value={phoneNumber} onChange={(e)=>{setPhoneNumber(e.target.value);}} placeholder=' +1 ' className="border border-[#C0C0C0] text-[#c0c0c0] sm:text-sm  rounded-md leading-5 font-normal font-rubik  block w-full p-2.5" />
                  ...
                  <div className='w-full'>
                    ...
                    <Field type="text" id="alias" name="alias" value={alias} onChange={(e)=>{setAlias(e.target.value);}} placeholder='Alias' className="border border-[#C0C0C0] text-[#c0c0c0] sm:text-sm  rounded-md leading-5 font-normal font-rubik  block w-full p-2.5" />
                ...
                <div className="w-full mb-4">
                  ...
                  <Field as="textarea" id="description" value={description} name="description" onChange={(e)=>{setDescription(e.target.value);}} rows="4" placeholder="Description" className="border border-[#C0C0C0] text-[#c0c0c0] sm:text-sm rounded-md leading-5 font-normal font-rubik block w-full p-2.5" />
