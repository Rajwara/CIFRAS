...
const quoteSchema = Yup.object().shape({
  quoteNumber: Yup.string().min(1, "It's too short").max(20, "It's too long").required('Please Enter Quote Number'),
  ...
  client: Yup.string().min(1, "It's too short").max(20, "It's too long").required('Please Enter Client'),
  item: Yup.string().min(1, "It's too short").max(20, "It's too long").required('Please Enter Item'),
  quantity: Yup.string().min(1, "It's too short").max(20, "It's too long").required('Please Enter Quantity'),
  price: Yup.string().min(1, "It's too short").max(20, "It's too long").required('Please Enter Price'),
  commission: Yup.string().min(1, "It's too short").max(20, "It's too long").required('Please Enter Commission'),
  rate: Yup.string().min(1, "It's too short").max(20, "It's too long").required('Please Enter Rate'),
  discount: Yup.string().min(1, "It's too short").max(20, "It's too long").required('Please Enter Discount'),
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-6'>
            <div className='w-full '>
              ...
              <Field
                ...
                className='border border-[#EBEBEB] text-[#c0c0c0] sm:text-sm  rounded-md leading-5 font-normal font-inter  block w-full p-2.5'
              />
              <ErrorMessage name="commission" component="div" className="text-red-500 text-sm mt-1" />
            </div>
            <div className='w-full '>
              <label
                htmlFor='rate'
...
//sidebar code for quote
  ...
  return (
    <div className='bg-white pl-4 py-4 pb-[130px] flex  flex-row flex-wrap '>
      ...
      <div
        className={`form flex flex-col bg-white py-8 px-10 border border-[#ebebeb] mt-[90px] ml-[60px] rounded w-[78%]`}
      >
         <Formik 
        ...
        <div className='flex justify-between  bg-white   items-center'>
          ...
          <div className='right flex flex-row gap-4 items-center justify-center mt-6'>
            ...
            type='submit'
            name='submit'
            value="submit"  className='flex py-[10px] px-[16px] bg-[#634af9] text-white rounded items-center gap-2'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12'>
              <div className='w-full'>
                ...
                <Field
                  ...
                  className='border border-[#EBEBEB] text-[#c0c0c0] sm:text-sm  rounded-md leading-5 font-normal font-inter  block w-full p-2.5'
                />
                 <ErrorMessage name="quoteNumber" component="div" className="text-red-500 text-sm mt-1" />
              </div>
              <div class='relative max-w-sm'>
                ...
                />
                 <ErrorMessage name="quoteDate" component="div" className="text-red-500 text-sm mt-1" />
              </div>
              <div class='relative max-w-sm'>
                <label
                ...
                <Field
                  ...
                  placeholder='Select date'
                />
                 <ErrorMessage name="notificationDate" component="div" className="text-red-500 text-sm mt-1" />
              </div>
              <div class='relative max-w-sm'>
                <label
