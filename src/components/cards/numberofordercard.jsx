...
const Numberofordercardsforotherpage = () => {
  return (
        ...
        <div className='top flex justify-between '>
            <div className='lefts flex items-center gap-4'>
              ...
              <img src={Icons} className='' alt='' />
                ...
                <div className=''>
                    <h6 className='font-normal font-lexend text-[#000000] text-xl leading-9'>Number of Orders</h6>
...
export default Numberofordercardsforotherpage