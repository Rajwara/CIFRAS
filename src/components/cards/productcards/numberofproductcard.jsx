...
const numberofproductcard = () => {
  return (
    ...
    <div className='top flex justify-between '>
        <div className='lefts flex items-center gap-4'>
          ...
          <img src={Icons} className='' alt='' />
            ...
            <div className=''>
                <h6 className='font-normal font-lexend text-[#000000] text-xl leading-9'>Num of Products</h6>
                <h6 className='font-bold font-lexend text-[#2591fa] text-xl leading-9'>1,800</h6>
    ...
    <div className='down flex items-center mt-2 gap-2' >
      ...
      <p className='font-medium font-inter text-[#04B076] text-xl leading-7'>+65.45%</p>
...
export default numberofproductcard