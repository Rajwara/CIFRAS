...
const Inventoryform = () => {
  ...
  const productformSchema = Yup.object().shape({
    itemnumber: Yup.string().min(1, "It's too short").max(20, "It's too long").required('Please Enter Item Number'),
    description: Yup.string().min(10, 'It\'s too short').required('Description is Required'),
    unitprice: Yup.string().min(2, 'Unit Price is too short').required('Unit Price is Required'),
    unitofmeasure: Yup.string().min(2, 'Unit of Measure is too short').required('Unit of Measure is Required'),
    vendor: Yup.string().min(2, "It's too short").max(200, "It's too long").required('Please Enter Your Vendor'),
    file: Yup.mixed().required('File is required'), // Add file validation
    onhandQty : Yup.string().min(1,"It's too short").max(20,"It's too long").required("On Hand Qty is Required"),
    incomingQty: Yup.string().min(1,"It's too short").max(20,"It's too long").required("Incoming Qty is Required"),
    reservedQty :Yup.string().min(1,"It's too short").max(20,"It's too long").required("Reserved Qty is Required"),
  });
