...
const Inventoryform = () => {
  ...
  const productformSchema = Yup.object().shape({
    ...
    unitprice: Yup.string()
      .min(2, "Unit Price is too short")
      .required("Unit Price is Required"),
    unitofmeasure: Yup.string()
      .min(2, "Unit of Measure is too short")
    ...
    onhandQty: Yup.string()
      .min(1, "It's too short")
      .max(20, "It's too long")
      .required("On Hand Qty is Required"),
    incomingQty: Yup.string()
      .min(1, "It's too short")
      .max(20, "It's too long")
      .required("Incoming Qty is Required"),
    reservedQty: Yup.string()
      .min(1, "It's too short")
      .max(20, "It's too long")
      .required("Reserved Qty is Required"),
  });
            ...
            {(props) => (
              <Form className='flex flex-col items-center justify-center'>
                ...
                <div className='inventory w-full border border-[#ebebeb] rounded p-8'>
                  <h6 className='text-[#634AF9] mb-2 text-lg font-inter font-bold leading-7'>
                    Inventory Detail
                  </h6>
                  <div className='flex flex-col md:flex-row gap-4 w-full mb-4'>
                    <div className='w-full'>
