      ...
      <h2 className="font-lexend text-2xl mt-[-25px] font-bold leading-tight text-[#404040] mb-8 ">
        ...
        <div className='upperform flex flex-row gap-6 w-full'>
              ...
              <Form className='flex flex-col items-center justify-center'>
                <div className='flex flex-row gap-4 mb-4 w-full'>
                  <div className='w-full'>
                    <label htmlFor="customerName" className="block mb-2 text-base font-normal text-[#404040] font-inter leading-7">Customer Name</label>
                    <Field type="text" id="customerName" name="customerName" placeholder='Customer name' className="border border-[#C0C0C0] text-[#c0c0c0] sm:text-sm  rounded-md leading-5 font-normal font-inter  block w-full p-2.5" />
                  ...
                  <div className='flex flex-row gap-4 mb-4 w-full'>
                  <div className='w-full'>
                    <label htmlFor="country" className="block mb-2 text-base font-normal text-[#404040] font-inter leading-7">Country</label>
                    <Field type="text" id="country" name="country"  placeholder='Country' className="border border-[#C0C0C0] text-[#c0c0c0] sm:text-sm  rounded-md leading-5 font-normal font-inter  block w-full p-2.5" />
                    <ErrorMessage name="country" component="div" className="text-red-500 text-sm mt-1" />
                  </div>
                  <div className='w-full'>
                    <label htmlFor="state" className="block mb-2 text-base font-normal text-[#404040] font-inter leading-7">State</label>
                    <Field type="text" id="state" name="state"  placeholder='State' className="border border-[#C0C0C0] text-[#c0c0c0] sm:text-sm  rounded-md leading-5 font-normal font-inter  block w-full p-2.5" />
                    <ErrorMessage name="state" component="div" className="text-red-500 text-sm mt-1" />
                  </div>
                </div>
                <div className='flex flex-row gap-4 mb-4 w-full'>
                  <div className='w-full'>
                    <label htmlFor="city" className="block mb-2 text-base font-normal text-[#404040] font-inter leading-7">City</label>
                    <Field type="text" id="city" name="city"  placeholder='City' className="border border-[#C0C0C0] text-[#c0c0c0] sm:text-sm  rounded-md leading-5 font-normal font-inter  block w-full p-2.5" />
                    <ErrorMessage name="city" component="div" className="text-red-500 text-sm mt-1" />
                  </div>
                  <div className='w-full'>
                    <label htmlFor="zipPostcode" className="block mb-2 text-base font-normal text-[#404040] font-inter leading-7">Zip / Postcode</label>
                    <Field type="text" id="zipPostcode" name="zipPostcode"  placeholder='Zip / Postcode' className="border border-[#C0C0C0] text-[#c0c0c0] sm:text-sm  rounded-md leading-5 font-normal font-inter  block w-full p-2.5" />
                    <ErrorMessage name="zipPostcode" component="div" className="text-red-500 text-sm mt-1" />
                  </div>
                </div>
                <div className='w-full'>
                  <label htmlFor="streetAddress" className="block mb-2 text-base font-normal text-[#404040] font-inter leading-7">Street Address</label>
                  <Field type="text" id="streetAddress" name="streetAddress"  placeholder='Street Address' className="border border-[#C0C0C0] text-[#c0c0c0] sm:text-sm  rounded-md leading-5 font-normal font-inter  block w-full p-2.5" />
                ...
                <div className='w-full mt-4 mb-2'>
                  <div className="flex items-center gap-4">
                    ...
                    <label for="checkbox-table-search-3" className=" font-inter font-normal text-[#404040] text-base leading-7">Shipping Address is the same as Billing Address</label>
                  </div>
                </div>
                <div className="w-full mb-4">
                  <label htmlFor="ordernote" className="block mb-2 text-base font-normal text-[#404040] font-inter leading-7">Order Note (optional)</label>
                  <Field as="textarea" id="ordernote"  rows="4" placeholder="Notes about your order, e.g. special notes for delivery." className="border border-[#C0C0C0] text-[#c0c0c0] sm:text-sm rounded-md leading-5 font-normal font-inter block w-full p-2.5" />
          ...
          <div className='right w-1/4 border border-[#ebebeb] rounded-md p-4'>
            ...
            <h4 className='font-lexend font-bold text-[#404040] text-xl leading-7'>Customer Info</h4>
           ...
           <div className='flex flex-row justify-between mt-4'>
            <h4 className='font-lexend font-bold text-[#404040] text-xl leading-7'>Order Detials</h4>
            <img src={Edit} alt="" className='h-6 w-6' />
            </div>
            <div className='flex flex-col gap-2 mt-2'>
            <h6 className='font-lexend font-normal text-[#404040] text-lg leading-5'>Order ID</h6>
            <h6 className='font-lexend font-normal text-[#404040] text-lg leading-5'>COMP1502</h6>
            </div>
            <img src={UnderLine} className='w-full mx-auto h-[2px] mt-4' alt="" />
            <div className="w-full mt-4 flex  flex-col gap-2">
              <label htmlFor="selectOption" className="font-inter font-normal text-[#404040] text-lg leading-5 ">
              Payment Method
              </label>
              <select
                as="select"
        ...
        <div className='downform flex flex-row justify-between mt-8'>
          ...
          <h4 className='font-lexend font-bold text-[#404040] text-xl leading-7 mb-4'>Your Order</h4>
          <div className='border border-[#ebebeb] rounded-md p-4 flex flex-col'>
            <div className='flex flex-row justify-between'>
            <h4 className='font-lexend font-normal text-[#404040] text-xl leading-7'>Ordered items</h4>
            <a className='font-inter font-normal text-[#2591FA] text-lg leading-7'>Edit Cart</a>
            </div>
            <img src={UnderLine} className='w-full mx-auto h-[2px] mt-4' alt="" />
            ...
            <div className='mt-6 mx-auto'>
              <button className='bg-[#634AF9] rounded-md px-5 py-3 text-white font-inter font-normal text-xl leading-7 '>Back to Store</button>
            </div>
          </div>
          </div>
        </div>
