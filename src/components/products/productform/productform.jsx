        ...
        <div className=''>
          ...
          >
            {(props) => (
              ...
              <div className="w-full mb-4">
                  <label htmlFor="description" className="block mb-2 sm:text-sm  font-normal text-[#404040] font-inter leading-7">Description</label>
                ...
                <div className='mt-6 w-full'>
                  ...
                  <div className="flex items-center justify-center w-full">
                    <label htmlFor="file" className="border  justify-center items-center border-[#C0C0C0] text-[#c0c0c0] sm:text-sm h-40 rounded-md leading-5 font-normal font-inter block w-full p-2.5">
