...
const Vendoreditform = () => {
  ...
  const vendorformSchema = Yup.object().shape({
    ...
    alias: Yup.string().min(2, "It's too short").max(20, "It's too long").required('Please Enter Your Alias'),
    ruc: Yup.string().min(2, "It's too short").max(20, "It's too long").required('Please Enter Your Ruc'),
    dv: Yup.string().min(2, "It's too short").max(20, "It's too long").required('Please Enter Your Dv'),
    address: Yup.string().min(10, 'It\'s too short').required('Address is Required'),
  });
