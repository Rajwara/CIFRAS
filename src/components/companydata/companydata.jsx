...
const Companydata = () => {
  return (
    <div className='main flex flex-col bg-white md:ml-[60px] mt-20 '>
      <div className='p-8'>
        <div className='flex flex-col gap-2 '>
          <h2 className='text-[#404040] text-2xl font-bold font=lexend leading-9'>
            Company Data
          </h2>
          <p className='text-[#404040] text-lg font-normal font-inter leading-7'>
        ...
        <div className='upper border border-[#ebebeb] rounded-md mt-10'>
          <div className='border border-[#ebebeb] p-8'>
            <h6 className='font-inter font-bold text-[#404040] text-xl leading-7'>
              General Data
            </h6>
          </div>
          <div className=' w-full p-8 grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div className='lg:w-[40%] '>
              <div>
                <div class='flex flex-col text-center items-center justify-center w-full'>
                  ...
                  <p className='text-[#404040] mt-4 text-lg font-inter font-normal leading-7'>
                    If you need help adding the logo,
                  </p>
                  <a
                    href='#'
                    className='text-[#634AF9] text-lg font-normal font-inter leading-7'
                  >
                    click here
                  </a>
                </div>
            ...
            <div className='lg:w-[60%] flex flex-col gap-4'>
              <div className='flex flex-row items-center justify-between'>
                <h6 className='font-lexend font-bold text-[#404040] text-xl leading-7'>
                  Name
                </h6>
              ...
              <div className='flex flex-row items-center justify-between'>
                ...
                <p className='font-inter font-normal text-[#c0c0c0] text-base leading-7'>
                  Not Registered
                </p>
              </div>
              <div className='flex flex-row items-center justify-between'>
